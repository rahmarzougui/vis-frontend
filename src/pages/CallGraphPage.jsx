          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  { value: 'direct', label: 'Direct Calls Only', description: 'Show immediate function calls' },
                  { value: '2levels', label: '2 Levels Deep', description: 'Include calls from called functions' },
                  { value: 'full', label: 'Full Call Tree', description: 'Complete call hierarchy' }
                ].map(option => (
